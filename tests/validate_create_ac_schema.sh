...
echo "=== Validating: create_ac_schema (CREATE scripts/tdd/schemas/ac.schema.json) ==="

echo "CHECK 1: Running validation command..."
if node -e "JSON.parse(require('fs').readFileSync('scripts/tdd/schemas/ac.schema.json','utf8'))"; then
