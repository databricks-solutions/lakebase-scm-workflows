...
echo "=== Validating: create_feature_schema (CREATE scripts/tdd/schemas/feature.schema.json) ==="

echo "CHECK 1: Running validation command..."
if node -e "JSON.parse(require('fs').readFileSync('scripts/tdd/schemas/feature.schema.json','utf8'))"; then
