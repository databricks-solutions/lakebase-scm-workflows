...
// branch in lockstep. These three operations encapsulate the coordination:
//
...
//
// `checkoutPaired` (git checkout + post-checkout .env refresh) is deferred to
// FEIP-7075 — that flow has subtle parent-branch fallback semantics that
// warrant their own milestone.
//
...
import { getEndpoint, getCredential, endpointPath } from "./branch-endpoint.js";
